...
ondenaoTronco :: (Terreno, [Obstaculo]) -> Coordenadas -> [Coordenadas]
ondenaoTronco (Rio n, []) (x,y) = []
ondenaoTronco (Rio n, (x':y')) (x,y) = if x' == Nenhum then (x,y) : ondenaoTronco (Rio n, y') (x+90, y) else ondenaoTronco (Rio n, y') (x+90, y)
...
ondeCarro :: (Terreno, [Obstaculo]) -> Coordenadas -> [Coordenadas]
ondeCarro (Estrada n, []) (x,y) = []
ondeCarro (Estrada n, (x':y')) (x,y) = if x' == Carro then (x,y) : ondeCarro (Estrada n, y') (x+90, y) else ondeCarro (Estrada n, y') (x+90, y)